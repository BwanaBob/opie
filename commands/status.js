  ...
  async execute(interaction) {
    ...
    switch (presenceType) {
      ...
      case 'status_streaming':
        ...
        break;
      case 'status_custom':
        parsedType = ActivityType.Custom;
        break;
    ...
    let newStatus = {
      ...
      activities: [{ type: parsedType, name: presenceText, },],
    }
    if (presenceType === "status_custom") {
      newStatus = {
        status: presenceStatus,
        activities: [{ type: parsedType, name: presenceText, state: presenceText, },],
      }
    }
