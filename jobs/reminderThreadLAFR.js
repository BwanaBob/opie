...
module.exports = {
    execute(client) {
        ...
        console.log(`[${jobLoadedDate}] ⌛ CRON  | Job Loaded    | Reminder LAFR Thread`);
        var jobSetThreadLALFR = new CronJob(
            '00 00 18 * * TUE', () => {
                // '*/15 * * * * *', () => {
                if (client.params.get("chatGPTAnnouncementsEnabled") == 'true') {
                    ...
                    if (nowDate > showEndDate) {
                        console.log(`[${jobExecutedDate}] ⌛ CRON  | Job Executed  | Reminder LAFR Thread (Show Ended)`);
                    } else {
                        ...
                        console.log(`[${jobExecutedDate}] ⌛ CRON  | Job Executed  | Reminder LAFR Thread`);
                    }
                }
            },
            null,
